...
var personalData = {
  ...
  homeOffice: "London",
  tellMeMore:"Hey! I am originally from Indonesia. I lived in Australia for 16 years before moving to London in 2016. I joined HomeAway London in March 2017. 2 Truths and 1 Lie about me: I am 4 foot 10, which makes me the shortest person over the age of 9 in the whole of Europe, I am short sighted and once stepped over a snake (mistaking it for a branch) and did  not get hurt, I represented Australia in the Women's Olympics 4 x 100m freestyle swim relay"
}
...
$(".btn-data").click(function() {
  ...
  myDetails.css('border', $(this).css('border'));
  myDetails.css('background-color', $(this).css('background-color'));
  myDetails.css('color', $(this).css('color'));
});
